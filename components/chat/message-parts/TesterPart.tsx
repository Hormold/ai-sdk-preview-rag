...
export function TesterPart({ part }: PartComponentProps) {
  ...
  // Type guard to narrow down to tool-openTester with output-available state
  if (part.type !== 'tool-openTester') {
    return null;
  }
  ...
  const description = part.output.description || "Open Connection Tester";
